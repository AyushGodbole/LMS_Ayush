...
image_icon = PhotoImage(file="src/LiveLecture/5590.png")
root.iconphoto(False,image_icon)

# color_box = PhotoImage(file="src/LiveLecture/colorStrip.png")
# Label(root,image=color_box,bg="#f2f3f5").place(x=10,y=20)

erasor = PhotoImage(file='src/LiveLecture/erasor3.png')
Button(root,image=erasor,bg='#f2f3f5',command=new_canvas).place(x=37,y=400)
